...
// ===== PAGING =====
$limit = 4; // jumlah user per halaman
...
<head>
    ...
    <style>
        ...
        .pagination a:hover { background: #5cafff; }
        .pagination .active {
            background: #5cafff;
            font-weight: bold;
        }
...
<div class="container">
    ...
    <div class="pagination">
        <?php
        if ($page > 1) {
            echo "<a href='5dashboard_admin.php?page=" . ($page - 1) . "'>Prev</a>";
        }
        ...
        for ($i = 1; $i <= $total_page; $i++) {
            if ($i == $page) {
                ...
                echo "<a href='5dashboard_admin.php?page=$i'>$i</a>";
            }
        }

        if ($page < $total_page) {
            echo "<a href='5dashboard_admin.php?page=" . ($page + 1) . "'>Next</a>";
        }
        ?>
    </div>
